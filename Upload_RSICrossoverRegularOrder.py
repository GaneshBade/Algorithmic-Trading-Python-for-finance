...
from StrategyRSICrossoverRegularOrder import StrategyRSICrossoverRegularOrder
...
print(inspect.getsource(StrategyRSICrossoverRegularOrder))

algobulls_connection.create_strategy(StrategyRSICrossoverRegularOrder, overwrite=True)
...
algobulls_connection.backtest(strategy_code=strategy_code1,
                              ...
                              end_timestamp=dt(year=2020, month=9, day=30, hour=15, minute=15),
