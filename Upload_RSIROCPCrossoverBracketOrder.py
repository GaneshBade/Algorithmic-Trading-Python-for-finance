...
from StrategyRSIROCPCrossoverBracketOrder import StrategyRSIROCPCrossoverBracketOrder

algobulls_connection = AlgoBullsConnection()
algobulls_connection.get_authorization_url()

algobulls_connection.set_access_token('ef4dfb04c5ea0d88020cbd3f04684b2dbbc2ba9c')

print(inspect.getsource(StrategyRSIROCPCrossoverBracketOrder))

algobulls_connection.create_strategy(StrategyRSIROCPCrossoverBracketOrder, overwrite=True)
...
algobulls_connection.backtest(strategy_code=strategy_code1,
                              start_timestamp=dt(year=2020, month=10, day=5, hour=9, minute=15),
